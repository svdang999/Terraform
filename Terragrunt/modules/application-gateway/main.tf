...
#   id = "/subscriptions/fdea6769-b01e-4a30-a3c6-dd170eb79a22/resourceGroups/rg-splg-dbp-gw-npd-ger-01/providers/Microsoft.Network/applicationGateways/${var.name}"  
# }
